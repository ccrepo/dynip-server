...
public final class IpServer extends HttpServlet {
	...
	private boolean doPostEndpointGet(HttpServletRequest request, HttpServletResponse response)
		...
		values.putAll(Map.ofEntries(entry(CONSTANT_HTTP_KEY_CREDENTIALS, new StringBuilder()),
	...
	/**
	 * HTTP message key '{@value CONSTANT_HTTP_KEY_CREDENTIALS}'.
	 */
	final public static String CONSTANT_HTTP_KEY_CREDENTIALS = "credentials";
	 ...
	 */
	final public static String CONSTANT_URI_ENDPOINT_GET = "/ipserver/server/ip/get";

	/**
	 * Parameter constant for the {@link javax.servlet.http.HttpServlet} query
	 * endpoint Uri '{@value CONSTANT_URI_ENDPOINT_QUERY}'.
	 */
	final public static String CONSTANT_URI_ENDPOINT_QUERY = "/ipserver/server/ip/query";

	/**
	 * Parameter constant for the {@link javax.servlet.http.HttpServlet} set
	 * endpoint Uri '{@value CONSTANT_URI_ENDPOINT_SET}'.
	 */
	final public static String CONSTANT_URI_ENDPOINT_SET = "/ipserver/server/ip/set";

	/**
	 * Parameter array containing Post-Get Http message fields for use in method
	 * {@link doPostEndpointGet}.
	 */
	final public static String[] CONSTANT_HTTP_KEYS_POST_GET = new String[] { CONSTANT_HTTP_KEY_CREDENTIALS,
	 ...
	 */
	final public static String[] CONSTANT_HTTP_KEYS_POST_SET = new String[] { CONSTANT_HTTP_KEY_CREDENTIALS,
